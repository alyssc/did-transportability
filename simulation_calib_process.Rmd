...
```{r}
# Demonstrating current error
new_params = global_params
calib_assist(new_params)

# I ran this with multiple sequences in order to come up with the best adjustment for targets in calib table 1, 
# which is now incorporated into global_params
# Not shown: adjustment for targets other than q (I just changed and ran the code in place)
